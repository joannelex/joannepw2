            ...
            <div className='about-text-container'>
                ...
                <div className='about-text-inner-container'>
                    ...
                    <div className='about-text'>
                        I’m Joanne (she/her), and I am a student, developer, artist and a 4th year computer science student at UBC.
                    </div>
                    <div className='space'></div>
                    <div className='about-text'>
                        Currently, I am working as a Software Engineer Intern @Amazon. When I’m not coding,
